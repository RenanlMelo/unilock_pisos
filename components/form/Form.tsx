...
export const Form = () => {
  return (
    <>
      <AnimatePresence>
        <motion.section id="form" className="contato_section">
          <Image
            className="contato_bg_image"
            src="/image_form_bg.png"
            alt="imagem de fundo"
            width={1920}
            height={1080}
          />
          <span className="contato_filter" />
          <div className="contato_informations">
            <div>
          ...
          >
            ...
            <input
              ...
              name="assunto"
              placeholder="Assunto"
              className="contato_assunto_input"
            />
            <textarea
              required
              name="mensagem"
